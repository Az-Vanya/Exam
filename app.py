...
MODEL_PATH_final = "mlmodels/model_final.pkl"
SCALER_X_PATH_final = "mlmodels/scaler_x_final.pkl"
SCALER_Y_PATH_final = "mlmodels/scaler_y_final.pkl"
...
def predict():
    ...
    if model == 2:
        ...
        # response = 'floor:{}, open_plan:{}, rooms:{}, area:{}, renovation:{}'.format(floor, open_plan, rooms, area, renovation)

        model2 = joblib.load(MODEL_PATH_final)
        sc_x2 = joblib.load(SCALER_X_PATH_final)
        sc_y2 = joblib.load(SCALER_Y_PATH_final)

        x2 = numpy.array([floor, open_plan, rooms, area, renovation]).reshape(1, -1)
